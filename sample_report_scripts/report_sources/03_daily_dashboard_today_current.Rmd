...
current_clean_cases <- get_latest_data("^cases_clean.*.csv", clean_folder)
current_clean_contacts <- get_latest_data("^contacts_clean.*.csv", clean_folder)
current_clean_followups <- get_latest_data("^followups_clean.*.csv", clean_folder)
